...
public class DataBase {
    ...
    // Note: This method only has to be executed once to create the database, once
    // all the tables are created, its as
    // simple as fetching/loading the data from/to the database respectively
    ...
    public static void main(String[] args) {
        ...
        //db.addAdmin("Kalundi", "password", "brian@brian");
        //db.addClassroom("CS", 1);
        //db.addPlayer("Tom", "password", "tom@tom", 1);

        //db.updatePlayerSandbox(1, "Callums Project", "1234");
        //db.updatePlayerProgress(1, 100, "1234");
        //db.updatePlayer(1, "Tommy Guy", "passwordNEW", "tom@tom", 1, false);
        //db.updateAdmin(1, "King", "secure", "king@king");
        db.deletePlayer(1);

        // db.updateHighScore(1, 100);
        // System.out.println(db.getAdminID(1));
        // System.out.println(db.getSandboxID(1));
        // System.out.println(db.getLevelID(1, 1));
        // System.out.println(db.getHighScore(1));
