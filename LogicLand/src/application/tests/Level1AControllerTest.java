...
import application.resources.levels.Level1AController;
...
class Level1AControllerTest extends platformTest {
	
		static Pane pane;
		static Level1AController controller;
		static Pane battery;
		static Pane bulb;
		...
		static void setUpBeforeClass() throws Exception {
			...
			if(!platformStarted) {
				...
				Platform.startup(() -> {
					FXMLLoader loader;
				try {
					loader = new FXMLLoader(sandboxControllerTest.class.getResource("/application/resources/levels/level1A.fxml"));
					pane = loader.load();
