...
import application.resources.levels.Level4AController.Type;
import application.resources.levels.Level4AController;
import javafx.application.Platform;
import javafx.fxml.FXMLLoader;
import javafx.scene.image.ImageView;
import javafx.scene.layout.Pane;

class Level4AControllerTest extends platformTest{

	static Pane pane;
	static Level4AController controller;
	static Pane battery;
	static Pane bulb;
	...
	static void setUpBeforeClass() throws Exception {
		...
		if(!platformStarted) {
			...
			Platform.startup(() -> {
				FXMLLoader loader;
			try {
				loader = new FXMLLoader(sandboxControllerTest.class.getResource("/application/resources/levels/level4A.fxml"));
				pane = loader.load();
