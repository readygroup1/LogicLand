...
import application.resources.levels.Level1BController;
import application.resources.levels.Level1BController.Type;
import javafx.application.Platform;
import javafx.fxml.FXMLLoader;
import javafx.scene.image.ImageView;
import javafx.scene.layout.Pane;

class Level1BControllerTest extends platformTest {

	static Pane pane;
	static Level1BController controller;
	static Pane battery;
	static Pane bulb;
	...
	static void setUpBeforeClass() throws Exception {
		...
		if(!platformStarted) {
			...
			Platform.startup(() -> {
				FXMLLoader loader;
			try {
				loader = new FXMLLoader(sandboxControllerTest.class.getResource("/application/resources/levels/level1B.fxml"));
				pane = loader.load();
