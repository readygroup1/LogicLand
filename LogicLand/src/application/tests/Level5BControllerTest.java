...
import application.resources.levels.Level5BController.Type;
import application.resources.levels.Level5BController;
import javafx.application.Platform;
import javafx.fxml.FXMLLoader;
import javafx.scene.image.ImageView;
import javafx.scene.layout.Pane;

class Level5BControllerTest extends platformTest{

	static Pane pane;
	static Level5BController controller;
	static Pane battery;
	static Pane bulb;
	...
	static void setUpBeforeClass() throws Exception {
		...
		if(!platformStarted) {
			...
			Platform.startup(() -> {
				FXMLLoader loader;
			try {
				loader = new FXMLLoader(platformTest.class.getResource("/application/resources/levels/level5B.fxml"));
				pane = loader.load();
