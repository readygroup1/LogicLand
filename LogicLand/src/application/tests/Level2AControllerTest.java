...
import application.resources.levels.Level2AController;
import application.resources.levels.Level2AController.Type;
import javafx.application.Platform;
import javafx.fxml.FXMLLoader;
import javafx.scene.image.ImageView;
import javafx.scene.layout.Pane;

class Level2AControllerTest extends platformTest {

	static Pane pane;
	static Level2AController controller;
	static Pane battery;
	static Pane bulb;
	...
	static void setUpBeforeClass() throws Exception {
		...
		if(!platformStarted) {
			...
			Platform.startup(() -> {
				FXMLLoader loader;
			try {
				loader = new FXMLLoader(sandboxControllerTest.class.getResource("/application/resources/levels/level2A.fxml"));
				pane = loader.load();
