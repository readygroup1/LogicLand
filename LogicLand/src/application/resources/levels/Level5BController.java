 ...
 * 
 * The `Level5BController` class is responsible for managing the user interface and logic of Level 5B.
 ...
 * 
 * The `Level5BController` class follows the JavaFX controller pattern and is designed to work with the LogicLand application.
	...
	// ----------------Variables ---------------------------------------
		...
		public void CheckToWin() {
			if(Textoutput1.getText().equals("1") && Textoutput2.getText().equals("0") && Textoutput3.getText().equals("0") && Textoutput4.getText().equals("0")) {
		        ...
		        alert.setContentText("Great Job! Level 5B Completed!");
				...
				if(AccountManager.getLevelScore(AccountManager.getLevelID(5)) != 75) {
					AccountManager.setLevelScore(AccountManager.getLevelID(5), 75);
				}
			} else {
		...
		/**
	     * Handles the action event for going back to Part A of Level 5.
	     * This method plays a "boop" sound, then switches the scene to Level 5A.
	     *
	    ...
	    public void previousLevel(ActionEvent event) throws IOException {
	    	audio.boopPlay();
	    	try {
	            String previousLevelFXML = "/application/resources/levels/level5A.fxml";
	    ...
	    public void nextLevel(ActionEvent event) throws IOException {
	    	...
	    	try {
	            String nextLevelFXML = "/application/resources/levels/level6A.fxml";
