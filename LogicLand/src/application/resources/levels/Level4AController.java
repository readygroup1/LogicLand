...
public class Level4AController extends sandboxController implements Initializable {
	...
	// ----------------Variables ---------------------------------------
		...
		// --------------------Initializer-----------------------------------------
		/**
		 * Initializes the Level4AController.
		...
		public void CheckWin() {
			...
			if(endBulb.getState()) {
		        ...
		        alert.setContentText("Great Job! Level 4A Completed!");
