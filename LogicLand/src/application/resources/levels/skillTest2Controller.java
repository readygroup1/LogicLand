...
/**
 * This class represents the controller for the skill test level 2 in the LogicLand application.
 * similar to levels It extends the `sandboxController` class. 
 * The skillTest2Controller` class is responsible for generating a level to challange the user.
 ...
 */
public class skillTest2Controller extends sandboxController implements Initializable {
	...
	// ----------------Variables ---------------------------------------
		...
		public void CheckWin() {
			//if bulb is on win
			if(endBulb.getState()) {
				title.setText("Excellent! You Know you stuff! ");
	    ...
	    public void previousLevel(ActionEvent event) throws IOException {
			...
			MusicPlayer.playBackgroundMusic();
	    	try {
	            String previousLevelFXML = "/application/resources/levels/level4B.fxml";
