...
/**
 * This class represents the controller for Level 6A in the LogicLand application.
 * It extends the `sandboxController` class and implements the `Initializable` interface.
 * 
 * The `Level6AController` class is responsible for managing the user interface and logic of Level 6A.
 ...
 * 
 * The `Level6AController` class follows the JavaFX controller pattern and is designed to work with the LogicLand application.
...
public class Level6AController extends sandboxController implements Initializable {
	...
	// ----------------Variables ---------------------------------------
		...
		// --------------------Initializer-----------------------------------------
		/**
		 * Initializes the Level6AController.
		...
		public void CheckWin() {
			...
			if(endBulb.getState()) {
		        ...
		        alert.setContentText("Great Job! Level 6A Completed!");
