...
/**
* The {@code norController} class represents a NOR gate controller extending {@link gateObject}.
* It contains functionality specific to NOR gate behavior in a circuit simulation.
*
* @version 1.0
* @since 1.0
* @author Group 1
...
public class norController extends gateObject implements Initializable{
	//----------------Variables-------------------
		...
		//----------------Initializer------------------
	 	/**
	     * Initializes the NOR gate controller.
		...
		/**
	     * Sets the image of the NOR gate to ON.
	     */
		...
		/**
	     * Sets the image of the NOR gate to OFF.
	     */
		...
		/**
	     * Sets the sandbox controller and circuit board pane for the NOR gate.
	     *
	     * @param board the sandbox controller to associate with the NOR gate
	     */
		...
		/**
	     * Gets the state of the NOR gate.
	     *
	     * @return the current state of the NOR gate
	     */
		...
		/**
	     * Sets the state of the NOR gate.
	     *
	     * @param inputState the new state to set for the NOR gate
	     */
		...
		/**
	     * Gets the type of the NOR gate.
	     *
	     * @return the type of the NOR gate
	     */
		public Type getType() {
			return type;
		}
		...
		/**
	     * Checks the type of the NOR gate and updates its state accordingly.
	     * If at least one input is false, the output is true, otherwise false.
	     */
		...
		/**
	     * Gets the input1 Rectangle of the NOR gate.
	     *
		...
		/**
	     * Gets the input2 Rectangle of the NOR gate.
	     *
		...
		/**
	     * Gets the output Rectangle of the NOR gate.
	     *
